...
public class MockScalingTest extends AbstractMockIntegrationTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(MockScalingTest.class);
...
//        get(AMBARI_API_ROOT + "/check", new AmbariCheckResponse());
        ...
        post(AMBARI_API_ROOT + "/clusters/:cluster/hosts", new AmbariClusterRequestsResponse(), gson()::toJson);
    }
