                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div ng-if="activeCluster.cluster.ambariServerIp != null">
                                        <a target="_blank" class="form-control-static review-a" href="https://{{activeCluster.cluster.ambariServerIp}}/ambari/">https://{{activeCluster.cluster.ambariServerIp}}/ambari/</a>
                                    </div>
                                    <div ng-if="activeCluster.cluster.ambariServerIp == null">
